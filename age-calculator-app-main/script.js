...
function hundleClick() {
    ...
    let spanYear = document.querySelector(".year-display");
    let spanMonth = document.querySelector(".month-display");
    let spanDay = document.querySelector(".day-display");
    let now = new Date()
    ...
    if (isNaN(dayValue) || dayValue > 30) {
        ...
        yearInput.style.border = "1px solid hsl(0, 100%, 67%)"
        alertYear.textContent = "Must be a valid year"
        yearlabel.style.color = "hsl(0, 100%, 67%)"
    }
    else {
